...
ARG GY_ACCOUNTS_DEFAULT_PICTURE_URL

ENV SPRING_PROFILE=${SPRING_PROFILE}
ENV SPRING_PORT=${SPRING_PORT}
ENV ALLOWED_API_KEY=${ALLOWED_API_KEY}
ENV FOTG_URL=${FOTG_URL}
ENV ACCOUNTS_MONGO_URI=${ACCOUNTS_MONGO_URI}
...
ENV GY_ACCOUNTS_DEFAULT_PICTURE_URL=${GY_ACCOUNTS_DEFAULT_PICTURE_URL}
...
RUN chmod 777 /app/gy-accounts.jar
